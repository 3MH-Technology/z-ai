...
import { Server, LogOut, LayoutDashboard, Wallet, Menu, X } from 'lucide-react';
        ...
        <div className="flex items-center justify-between h-16">
          <div className="flex items-center">
            <Link to="/" className="flex items-center gap-2 group">
              <span className="text-lg sm:text-xl font-bold tracking-tighter text-white uppercase">{globalSettings?.siteName || 'White Wolf'}</span>
            </Link>
          </div>
