    ...
    <footer className="py-12 border-t border-white/10 px-4 sm:px-6 lg:px-8 bg-[#050505]" dir="rtl">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-12">
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center gap-2 mb-6">
              ...
              <span className="text-xl font-bold tracking-tighter">White Wolf</span>
            </div>
        ...
        <div className="pt-8 border-t border-white/5 flex flex-col md:flex-row items-center justify-between gap-6">
          <p className="text-gray-600 text-xs">&copy; 2026 White Wolf t.me/j49_c channel t.me/bshshshkk</p>
        </div>
      </div>
    </footer>
  );
